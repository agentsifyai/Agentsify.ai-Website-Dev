                        ...
                        <div className="lg:col-span-4">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 max-w-4xl">
                                <div className="lg:col-span-2 bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                                    <h3 className="text-base font-semibold text-white mb-2">{t('stayupdatedtext')}</h3>
                                    <p className="text-slate-400 text-sm mb-3">{t('suscribetext')}</p>
                                    {isSubscribed ? (
                                ...
                                <div className="lg:col-span-1 bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-xl p-4 border border-slate-700">
                                    <div className="flex items-center mb-2">
                                        ...
                                        <h3 className="text-base font-bold text-white">{t('partnerprogramheading')}</h3>
                                    </div>
                    ...
                    <div className="border-t border-slate-800 pt-6">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex items-center space-x-4">
                                <span className="text-slate-400 text-sm mr-2">{t('followustext')}</span>
